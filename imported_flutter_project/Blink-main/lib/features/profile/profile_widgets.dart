...
import 'package:blink/features/market/widgets/product_card.dart';
import 'package:blink/features/market/product_detail_screen.dart';
...
class ProfileContentTabs extends StatefulWidget {
  ...
  final List<MarketItem> listings;
  final bool isDark;
  final Color txt;
  final Color muted;
  final Color accent;
        ...
        Container(
          ...
          child: TabBar(
            ...
            tabs: const [
              ...
              Tab(icon: Icon(Icons.storefront_outlined, size: 18), text: 'Market'),
        ...
        SizedBox(
          ...
          child: TabBarView(
            ...
            children: [
              ...
              _MarketListingsTab(listings: widget.listings, isDark: widget.isDark, muted: widget.muted, txt: widget.txt, onSnack: widget.onSnack, emptyLabel: widget.isOwner ? 'You have no listings' : 'No active listings'),
...
class _MarketListingsTab extends StatelessWidget {
  final List<MarketItem> listings;
  final bool isDark;
  final Color muted;
  final Color txt;
  ...
  @override
  Widget build(BuildContext context) {
    if (listings.isEmpty) return _EmptyTabState(icon: Icons.storefront_outlined, label: emptyLabel, muted: muted);
    ...
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        ...
        mainAxisSpacing: 16,
        crossAxisSpacing: 16,
        childAspectRatio: 0.65, // matches market screen
      ),
      itemBuilder: (context, i) {
