...
import 'package:blink/features/market/seller_service.dart';
...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      final listings = user != null ? await SellerService.fetchSellerListings(user.id) : <MarketItem>[];
      if (listings.isEmpty) {
        listings.addAll(marketItems.where((i) => i.seller == p.username));
      }
